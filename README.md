...
This repository ships sixty-seven small, tool-free Agent Skills for evidence-first PM
work:
...
Use the smallest matching skill first; do not chain all sixty-seven before
...
**Public skill pilot:** Try one of the sixty-seven first runs with a real, sanitized note, then
