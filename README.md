...
This repository ships sixty-eight small, tool-free Agent Skills for evidence-first PM
work:
...
Use the smallest matching skill first; do not chain all sixty-eight before
...
**Public skill pilot:** Try one of the sixty-eight first runs with a real, sanitized note, then
