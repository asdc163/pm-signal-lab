...
This repository ships sixty-four small, tool-free Agent Skills for evidence-first PM
work:
...
Use the smallest matching skill first; do not chain all sixty-four before
...
**Public skill pilot:** Try one of the sixty-four first runs with a real, sanitized note, then
