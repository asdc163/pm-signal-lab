...
export const SAMPLE_PACK: EvidencePack = {
  ...
  description:
    "Four fictional signals from an interview, support note, product observation, and evaluation review. Keep the user's line separate from the decision it may support.",
  evidence: [
    {
