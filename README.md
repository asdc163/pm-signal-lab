...
![PM Signal Lab current first-run workbench](./docs/product/pm-signal-lab/assets/qa/first-run-current-1280.png)

Current first-run screenshot captured from the local build on 2026-08-15 at
1280×900. The image covers the empty state only; use the hosted demo for the
loaded, review, export, and feedback flows.
