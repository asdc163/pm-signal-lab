...
export, download, keyboard, and privacy-gated feedback flows. Use the hosted
demo for the post-deploy release evidence.

## What is in the hosted demo

- A deterministic, fictional AI support-copilot sample pack containing interview, support, product-observation, and evaluation-review signals.
