...
This repository ships thirty-eight small, tool-free Agent Skills for evidence-first PM
work:
...
Use the smallest matching skill first; do not chain all thirty-eight before
...
**Public skill pilot:** Try one of the thirty-eight first runs with a real, sanitized note, then
