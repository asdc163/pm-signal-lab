...
Latest visual pass: [operational worksheet reframe contract](./docs/product/pm-signal-lab/86-operational-worksheet-no-ai-reframe-contract-2026-08-16.md) and [operational worksheet local QA report](./docs/product/pm-signal-lab/87-operational-worksheet-local-qa-2026-08-16.md). The current local candidate passed a headless Chrome CDP fallback at `390×844` and `1280×900`; the preferred Chrome Extension route and canonical Pages behavior still require separate evidence.
...
**Design and QA evidence:** The current visual direction and current-turn evidence are in the [operational worksheet contract](./docs/product/pm-signal-lab/86-operational-worksheet-no-ai-reframe-contract-2026-08-16.md) and [local QA report](./docs/product/pm-signal-lab/87-operational-worksheet-local-qa-2026-08-16.md). The [quiet workpaper second-polish contract](./docs/product/pm-signal-lab/82-quiet-workpaper-second-polish-contract-2026-08-16.md), [editorial case-sheet contract](./docs/product/pm-signal-lab/78-editorial-case-sheet-visual-reframe-contract-2026-08-15.md), and earlier no-AI-feel, keyboard/semantic, copy, AI-PM, and hosted audits remain available as the historical release trail.
