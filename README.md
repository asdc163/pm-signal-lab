...
This repository ships sixty-nine small, tool-free Agent Skills for evidence-first PM
work:
...
Use the smallest matching skill first; do not chain all sixty-nine before
...
**Public skill pilot:** Try one of the sixty-nine first runs with a real, sanitized note, then
