...
This repository ships fifty-two small, tool-free Agent Skills for evidence-first PM
work:
...
Use the smallest matching skill first; do not chain all fifty-two before
...
**Public skill pilot:** Try one of the fifty-two first runs with a real, sanitized note, then
