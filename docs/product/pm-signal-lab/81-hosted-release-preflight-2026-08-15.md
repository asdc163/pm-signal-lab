...
| PR head currently observed | `bc27428` — current release-evidence refresh on top of the `0d18eb8` product candidate; CI run `31928028107` is green |
...
- [x] The public/private boundary is preserved; the private star plan is not
  staged or published.
- [x] PR #44 CI is green for pushed head `bc27428`; run `31928028107`
...
1. Confirm PR #44 is open, clean, and CI-green, and that its current head
   ...
   gate (currently head `bc27428`, or the exact newer reviewed head).
